...
const SVG_DISTANCE = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 32"><polygon points="0,16 12,8 12,24" fill="#212121"/><line x1="12" y1="16" x2="84" y2="16" stroke="#212121" stroke-width="3" stroke-linecap="round"/><polygon points="96,16 84,8 84,24" fill="#212121"/><rect x="32" y="6" width="32" height="20" rx="3" fill="#fff" stroke="#212121" stroke-width="1.5"/></svg>`;
