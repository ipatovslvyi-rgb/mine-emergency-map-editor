...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { q: 'Печать / PDF', a: 'Нажмите кнопку «Печать / PDF» в верхней панели. Откроется системный диалог браузера — выберите принтер или сохраните как PDF.' },
      { q: 'Предпросмотр', a: 'Нажмите кнопку «Предпросмотр» для просмотра документа в формате А4 перед печатью.' },
      { q: 'Сохранить как JSON (резервная копия)', a: 'Нажмите кнопку «JSON» в верхней панели. Файл сохранится на компьютер. Восстановить его можно через раздел «Схемы» → кнопка «Импорт».' },
      { q: 'Почему важно делать резервные копии?', a: 'Все схемы хранятся локально в браузере. При очистке истории браузера данные удалятся. Сохраняйте схемы в JSON регулярно.' },
    ]
  },
  {
    id: 'schemas',
    ...
    items: [
      { q: 'Как импортировать схему из файла?', a: 'Перейдите в раздел «Схемы» и нажмите кнопку «Импорт». Выберите файл .json, сохранённый ранее — схема откроется автоматически.' },
      { q: 'Как удалить схему?', a: 'В разделе «Схемы» нажмите на иконку корзины. Появится диалог подтверждения — удаление нельзя отменить.' },
      { q: 'Как дублировать схему?', a: 'Нажмите кнопку копирования рядом со схемой. Создастся точная копия с пометкой «(копия)».' },
      { q: 'Как переименовать схему?', a: 'Нажмите иконку карандаша рядом со схемой или кликните на название в верхней панели редактора.' },
    ]
  },
  {
    id: 'shortcuts',
        ...
        <div className="p-4 rounded-lg mb-5 border-l-4 flex items-start gap-3"
          ...
          <div>
            ...
            <p className="text-xs mt-1" style={{ color: 'hsl(var(--muted-foreground))' }}>
              ...
              Схемы хранятся локально в браузере. Для резервного копирования используйте экспорт в JSON (кнопка «JSON» в верхней панели) — файл можно восстановить через «Импорт» в разделе «Схемы».
            </p>
          </div>
        </div>
