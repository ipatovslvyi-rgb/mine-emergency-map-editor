...
<div class="sheet">
  ...
  <div class="footer"><span>САУ v1.003 — Схема аварийного участка</span><span>Все права защищены © 2025</span></div>
</div>
</body></html>`;
}
          ...
          <div style={{ width: SHEET_W * scale, height: SHEET_H * scale, flexShrink: 0 }}>
            <div style={{
              ...
              <div style={{ borderTop: '1px solid #e5e7eb', padding: '12px 44px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0, marginTop: 'auto' }}>
                <span style={{ fontSize: 8, color: '#9ca3af' }}>САУ v1.003 — Схема аварийного участка</span>
